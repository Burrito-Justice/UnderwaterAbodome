...
/datum/gear_tweak/custom_name/tweak_item(var/user, var/obj/item/I, var/metadata)
	if(!metadata)
		return I.name
	I.name = metadata
...
/datum/gear_tweak/custom_desc/tweak_item(var/user, var/obj/item/I, var/metadata)
	if(!metadata)
		return I.desc
	I.desc = metadata