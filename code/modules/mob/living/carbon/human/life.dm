...
/mob/living/carbon/human/handle_environment(datum/gas_mixture/environment)
	...
	if(adjusted_pressure >= species.hazard_high_pressure)
		var/pressure_damage = max( ( (adjusted_pressure / species.hazard_high_pressure) -1 )*PRESSURE_DAMAGE_COEFFICIENT , MAX_HIGH_PRESSURE_DAMAGE)
		take_overall_damage(brute=pressure_damage, used_weapon = "High Pressure", armor_pen = 100)
		pressure_alert = 2
